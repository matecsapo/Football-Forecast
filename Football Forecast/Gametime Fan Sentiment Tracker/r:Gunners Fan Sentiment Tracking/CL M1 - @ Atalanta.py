...
#NECESSARY INFO
Pre_Match_Thread_ID = "1fivfzr"
Match_Thread_ID = "1fkr2p4"
Post_Match_Thread_ID = "1fkuujf"
Kickoff_TimeStamp = 1726772520
Stoppage_Time_1 = 60
Second_Kickoff_Timestamp = 1726776240
Stoppage_Time_2 = 240
...
for comment in post.comments.list():
    if comment.created_utc <= Second_Kickoff_Timestamp + 1*300:
